...
작성 2026-08-04 · 근거는 `docs/reports/2026-08-04_plan.md` §1~§4 · 미해결 항목은 `findings/registry.yaml` TRN-001~010
...
| 단계 | 내용 | 회수 | 이 단계 (100에폭 상한) | 누적 | 완결되는 것 |
|---|---|---:|---|---|---|
| **A** | CALB 9회 | 9 | ~0.9시간 | ~0.9시간 | **Table 3 CALB 열 완성** |
| **B** | Na-ion 9회 | 9 | ~1.0시간 | ~1.9시간 | **Na-ion 열 완성** |
| **C** | Zn-ion 9회 | 9 | ~3.3시간 | ~5.2시간 | **Zn-ion 열 완성** |
| **D** | Li-ion 9회 | 9 | ~27.9시간 | ~33시간 | **Li-ion 열 완성** |
...
조건에서 얻은 값이라는 뜻이 됩니다. 최소한 모든 행에 `docs/RUN.md` §8 의
...
4. `docs/RUN.md` §8 조건 차이표에 이번에 확인된 것 반영 (이미 갱신했습니다)
